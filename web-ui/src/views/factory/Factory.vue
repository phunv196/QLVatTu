...
import FactoryApi from "@/api/factory-api"; // eslint-disable-line import/no-cycle
import FactoryDetails from "@/views/factory/FactoryDetails.vue";
import Import from "@/views/factory/Import.vue";

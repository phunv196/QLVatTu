...
import UnitApi from '@/api/unit-api'; // eslint-disable-line import/no-cycle
import UnitDetails from '@/views/unit/UnitDetails.vue';
...
export default defineComponent({
  setup(): unknown {
    ...
    const confirmDialog = (rec: Record<string, unknown>) => {
      confirm.require({
        message: `Bạn có muốn xóa bản ghi ${rec.name} không?`,
        header: "Xác nhận!",

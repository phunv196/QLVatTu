...
import WarehouseCardApi from "@/api/warehouse-card-api"; // eslint-disable-line import/no-cycle
import WarehouseCardDetails from "@/views/warehouse-card/WarehouseCardDetails.vue";

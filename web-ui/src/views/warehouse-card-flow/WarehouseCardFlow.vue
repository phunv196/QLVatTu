...
<!--      <Button icon="pi pi-user" iconPos="right" label="Thêm mới" @click="onAddClick()"-->
...
import WarehouseCardFlowApi from '@/api/warehouse-card-flow-api'; // eslint-disable-line import/no-cycle
import WarehouseCardFlowDetails from '@/views/warehouse-card-flow/WarehouseCardFlowDetails.vue';

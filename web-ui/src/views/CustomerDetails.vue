  ...
  <div class="m-font-regular">
    ...
    <h4>
      ...
      <span style="color: var(--primary-color)">
        {{ recData.customerId ? recData.customerId : "NEW" }}
      </span>
    </h4>
    ...
    <div>
      <div class="">
        ...
        <InputText
          type="text"
          v-model="recData.address1"
          class="p-inputtext-sm p-mr-1"
        />
        <InputText
          type="text"
          v-model="recData.address2"
          class="p-inputtext-sm"
        />
      </div>
      <div class="p-mt-1">
  ...
  setup(props, { emit }): unknown {
    ...
    const onApplyChanges = async () => {
      ...
      if (resp.data.msgType === "SUCCESS") {
        toast.add({
          severity: "success",
          summary: rawCustomerObj.id
            ? "Sửa thành công!"
            : "Thêm mới thành công!",
          detail: `${rawCustomerObj.firstName} ${rawCustomerObj.lastName}`,
          life: 3000,
        });
        if (!rawCustomerObj.id) {
        ...
        toast.add({
          severity: "error",
          summary: "Error updating customer",

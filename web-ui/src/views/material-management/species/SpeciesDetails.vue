  ...
  <div class="m-font-regular">
    ...
    <h4>
      ...
      <span style="color: var(--primary-color)">
        {{ recData.speciesId ? recData.speciesId : "NEW" }}
      </span>
    </h4>
    ...
    <div>
      ...
      <div class="p-mt-3 p-d-flex p-ai-center">
        ...
        <textarea
          ...
          class="p-inputtext p-component p-inputtext-sm p-col-8"
          maxlength="500"
        />
      </div>
    </div>
...
export default defineComponent({
  ...
  setup(props, { emit }): unknown {
    ...
    const onApplyChanges = async () => {
      ...
      let msg: any[];
      msg = [];
      if (!rawSpeciesObj.code) {
        msg.push("mã chủng loại");
      }
      if (!rawSpeciesObj.name) {
        msg.push("tên chủng loại");
      }
      if (msg.length > 0) {
        userMessage.value =
        ...
        if (check.data) {
          ...
          if (resp.data.msgType === "SUCCESS") {
            toast.add({
              severity: "success",
              summary: rawSpeciesObj.speciesId
                ? "Product Updated"
                : "Product Added",

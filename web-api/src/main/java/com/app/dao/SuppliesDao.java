...
public class SuppliesDao extends BaseHibernateDAO {
    ...
    public  List<SuppliesModel> getList(int from, int limit, Long suppliesId, String searchCode,String searchName,
                                       Long searchSupplier,String searchSpecies,Long searchFormPrice,Long searchToPrice,
                                        String searchQuality,String searchUnit)  throws HibernateException, ConstraintViolationException {
        ...
        if (searchSpecies != null)   { q.setParameter("searchSpecies", searchSpecies); }
        ...
        if (searchQuality != null)   { q.setParameter("searchQuality", searchQuality); }
        if (searchUnit != null)   { q.setParameter("searchUnit", searchUnit); }
    ...
    public  BigInteger getSuppliesCount(Long suppliesId, String searchCode,String searchName,
                                        Long searchSupplier,String searchSpecies,Long searchFormPrice,Long searchToPrice,
                                        String searchQuality,String searchUnit) {
        String sql = createSqlWhereString(suppliesId, searchCode, searchName,
                searchSupplier, searchSpecies, searchFormPrice, searchToPrice, searchQuality, searchUnit);
    ...
    private  String createSqlWhereString(Long suppliesId, String searchCode,String searchName,
        ...
        if (searchSpecies != null)   { sqlWhere = sqlWhere + " and s.species_id = :searchSpecies "; }
        ...
        if (searchQuality != null)   { sqlWhere = sqlWhere + " and s.quality_id = :searchQuality "; }
        if (searchUnit != null)   { sqlWhere = sqlWhere + " and s.unit_id = :searchUnit "; }
        return sqlWhere;
    }

    public List<SuppliesModel> getListExport(String code, String name, Long supplierId, Long formPrice, Long toPrice, String qualityId, String unit) {
    ...
    public List<SuppliesModel> getByWarehouseId(Long warehouseId, Long suppliesId) {
        ...
        List<Object> paramList = new ArrayList<>();
        StringBuilder strCondition = new StringBuilder(" WHERE 1 = 1 and s.inventory > 0 ");
        if (suppliesId != null) {
            CommonUtils.filterNe(suppliesId, strCondition, paramList, "s.supplies_id");
        }
